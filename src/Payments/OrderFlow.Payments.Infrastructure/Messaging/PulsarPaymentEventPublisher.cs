...
public sealed class PulsarPaymentEventPublisher
    : IPaymentEventPublisher, IAsyncDisposable
{
    private readonly IPulsarClient _client;
    private readonly IProducer<string> _producer;

    public PulsarPaymentEventPublisher(
        IOptions<PulsarOptions> options,
        ILogger<PulsarPaymentEventPublisher> logger)
    {
