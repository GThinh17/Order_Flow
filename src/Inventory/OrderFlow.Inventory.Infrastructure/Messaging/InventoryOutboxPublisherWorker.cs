...
public sealed class InventoryOutboxPublisherWorker : BackgroundService
{
    ...
    private readonly ILogger<InventoryOutboxPublisherWorker> _logger;

    public InventoryOutboxPublisherWorker(
